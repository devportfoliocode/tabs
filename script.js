...
function tabs() {
    ...
    const quartaCategoria = document.querySelector('.tab-categoria-4')
    ...
    const quartoConteudo= document.querySelector('.tab-conteudo-4')
    ...
    quartaCategoria.addEventListener('click', () => {
        removeConteudoVisivel()
        removeCategoriaAtiva()

        quartaCategoria.classList.add('tab-categoria-ativa')
        quartoConteudo.classList.add('tab-conteudo-visivel')
    })
